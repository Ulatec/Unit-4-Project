...
public class BlogEntries {
    public static BlogEntry[] load(){
        return new BlogEntry[] {
                ...
                new BlogEntry("The power of the Nokia 3310","This is being run on a Nokia 3310 that someone forgot in a Tokyo subway station after heroically finding an electrical outlet to charge it with.", new Date()),
